...
# class Gato: # Para la definicion de objetos se usa CamelCase
#     def __init__(self, nombre, edad=5):
#         self.nombre = nombre
#         self.edad = edad
    
#     def maullear(self, otro_nombre):
#         print(f"El gato {self.nombre} dice: Miau a {otro_nombre}")
...
# print(primer_auto.mostrar_info())
