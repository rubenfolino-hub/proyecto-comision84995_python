...
def modificar_global():
    global variable_global_modificable
    variable_global_modificable = 30
...
def intentar_modificar_global():
    variable_global_no_modificada = 100
...
def sumar(*args): #[1, 2, 3] // [4,5] // [10,20,30,40]
    """
...
numeros = [1, 2, 3, 4]
print("Sumar lista desempaquetada:", sumar(*numeros))  # sumar(1,2,3,4)
